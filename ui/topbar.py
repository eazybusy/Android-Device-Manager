"""
ui/topbar.py — Main application top bar.
States: connecting / connected / disconnected + run_busy guard.
"""
...
class TopBar(ctk.CTkFrame):
    def __init__(self, parent, on_connect, on_open_profiles, on_run):
        super().__init__(parent, fg_color=BG_PANEL, height=56, corner_radius=0)
        self.pack(fill="x", side="top")
        self.pack_propagate(False)

        self._run_idle_text = "Run All"
        ...
        ctk.CTkLabel(
            ...
            text_color=ACCENT, width=34, height=34,
            corner_radius=8, fg_color=ACCENT_SOFT,
        ).pack(side="left", pady=11)

        ctk.CTkLabel(
            brand, text="  Android Device Manager",
        ...
        self._run_btn = ctk.CTkButton(
            ...
            text_color="white", command=on_run,
        )
        self._run_btn.pack(side="right", padx=(6, 0), pady=11)
        ...
        ctk.CTkButton(
            ...
            font=ctk.CTkFont(size=12), text_color=TEXT_LABEL,
        ...
        self._connect_btn.pack(side="right", padx=4, pady=11)

        # Centre device status
        ...
        self._dev_label = ctk.CTkLabel(
            dev_row, text="  No device connected",
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(size=FONT_MICRO), text_color=TEXT_MUTED,
        ).pack(side="left")
    ...
    def set_connecting(self) -> None:
        self._dev_dot.configure(text_color=YELLOW)
        self._dev_label.configure(text="  Connecting...", text_color=YELLOW)
    ...
    def set_connected(self, device_str: str) -> None:
        ...
        self._connect_btn.configure(state="normal", text="Refresh")

    def set_disconnected(self) -> None:
        self._dev_dot.configure(text_color=RED)
        self._dev_label.configure(
            text="  No device connected", text_color=TEXT_MUTED)
    ...
    def set_run_busy(self, busy: bool) -> None:
        if busy:
            ...
            self._run_btn.configure(state="normal", text=self._run_idle_text)
